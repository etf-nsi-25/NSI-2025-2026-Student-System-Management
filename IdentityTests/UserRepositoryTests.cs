...
public class UserRepositoryTests : IDisposable
{
    ...
    private void SeedData()
    {
        ...
        _context.DomainUsers.Add(User.Create("teacher_a", new byte[1], "Teacher", "A", FacultyA, UserRole.Teacher).SetId(Guid.NewGuid()));
        
        _context.DomainUsers.Add(User.Create("student_b", new byte[1], "Student", "B", FacultyB, UserRole.Student).SetId(Guid.NewGuid()));
        
        _context.DomainUsers.Add(User.Create("student_a", new byte[1], "Student", "A", FacultyA, UserRole.Student).SetId(Guid.NewGuid()));
