    ...
    return (
        <div className="student-portal-wrapper">
            ...
            <div className="assistant-header">
                ...
                >
                    <span className="user-name">{authInfo?.fullName || 'Superadmin'}</span>
                </div>
            </div>
                ...
                <CSidebarNav>
                    ...
                    <CNavItem>
                        ...
                        >
                            ...
                            {(!isCollapsed || isMobile) && 'University Dashboard'}
                        </NavLink>
                    </CNavItem>

                    <CNavItem>
                        <NavLink 
                            to="/superadmin/course-management" 
                            className="nav-link"
                            onClick={handleNavClick}
                        >
                    ...
                    <CNavItem>
                        <NavLink 
                            to="/superadmin/tenant-management" 
                            className="nav-link"
                            onClick={handleNavClick}
                        >
                            <CIcon customClassName="nav-icon" icon={cilContact} />
                    ...
                    <CNavItem>
                        ...
                        >
                            ...
                            {(!isCollapsed || isMobile) && 'University Profile Settings'}
                        </NavLink>
                    </CNavItem>
                </CSidebarNav>
