        ...
        <div className="student-portal-wrapper">
            ...
            <div className="assistant-header">
                ...
                <div 
                    ...
                    data-initial={authInfo?.fullName ? authInfo.fullName.charAt(0) : 'T'}
                >
                    <span className="user-name">{authInfo?.fullName || 'Teacher'}</span>
                </div>
            </div>
                ...
                <CSidebarNav>
                    ...
                    <CNavItem>
                        ...
                        >
                            ...
                            {(!isCollapsed || isMobile) && 'Professor dashboard'}
                        </NavLink>
                    </CNavItem>

                    <CNavItem>
                        <NavLink 
                            to="/teacher/document-center" 
                            className="nav-link"
                            onClick={handleNavClick}
                        >
                    ...
                    <CNavItem>
                        ...
                        >
                            ...
                            {(!isCollapsed || isMobile) && 'Professor Profile Settings'}
                        </NavLink>
                    </CNavItem>

                    <CNavTitle style={{ display: isCollapsed && !isMobile ? 'none' : 'block' }}>Help</CNavTitle>
                    ...
                    <CNavItem>
                        ...
                        >
                            ...
                            {(!isCollapsed || isMobile) && 'Professor support'}
                        </NavLink>
                    </CNavItem>
                </CSidebarNav>
